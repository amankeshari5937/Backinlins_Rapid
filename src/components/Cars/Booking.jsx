    ...
    <div className="w-full bg-white py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-lg p-8 shadow-lg flex flex-col md:flex-row items-center justify-between">
          ...
          <Link href="/calculator" className="inline-flex items-center bg-white text-orange-600 font-bold py-3 px-6 rounded-full shadow-md hover:bg-orange-50 transition duration-200">
