    ...
    <div className="bg-gradient-to-br from-pink-50 to-white rounded-xl shadow-md p-4 sm:p-6 md:p-8">
      ...
      <div className="mb-6 sm:mb-8">
        <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-700 flex items-center">
          ...
          <span className="text-sm sm:text-base">Business Hours (Eastern Time)</span>
        </h3>
        ...
        <div className="space-y-3 sm:space-y-4 bg-white rounded-lg p-3 sm:p-4 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-orange-100 pb-2 sm:pb-3">
            <div className="flex items-center mb-1 sm:mb-0">
              ...
              <span className="font-medium text-sm sm:text-base">Monday to Friday</span>
            </div>
            <span className="text-orange-600 font-medium text-sm sm:text-base pl-6 sm:pl-0">Open 24 hours</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-orange-100 pb-2 sm:pb-3">
            <div className="flex items-center mb-1 sm:mb-0">
              ...
              <span className="font-medium text-sm sm:text-base">Weekend Days</span>
            </div>
            <span className="text-orange-600 font-medium text-sm sm:text-base pl-6 sm:pl-0">8:00 am - 8:00 pm</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
            <div className="flex items-center mb-1 sm:mb-0">
              ...
              <span className="font-medium text-sm sm:text-base">Public Holidays</span>
            </div>
            <span className="text-orange-600 font-medium text-sm sm:text-base pl-6 sm:pl-0">8:00 am - 8:00 pm</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="font-medium text-sm sm:text-base break-all">info@rapidautoshipping.com</p>
            </div>
          </div>
        </div>
