  ...
  return (
    <>
      <Head>
        ...
        <title>{`${state_to_state?.from} to ${state_to_state?.to} Auto Shipping | Rapid Auto Shipping`}</title>

        {/* Single authoritative description — deduplicated metaTags won't add another */}
        <meta
          name="description"
        ...
        <meta property="og:site_name" content="Rapid Auto Shipping" />
        ...
        <meta name="twitter:site" content="@ShippingRapid" />
        <meta name="twitter:creator" content="@ShippingRapid" />
        <meta
          name="twitter:title"
          content={`${state_to_state?.from} to ${state_to_state?.to} Auto Shipping | Rapid Auto Shipping`}
        />
        ...
        {/* Remaining meta tags (description + og:description already excluded above) */}
