...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>Komatsu Equipment Shipping | Safe Hauling & Low Rates</title>
        <meta
          name="description"
          content="Rapid Auto Shipping offers nationwide, specialized shipping services for Komatsu equipment. We provide insured machinery moves and guarantee safe delivery."
        />
        <meta charSet="UTF-8" />
        ...
        <meta
          property="og:title"
          content="Komatsu Equipment Shipping | Safe Hauling & Low Rates"
        />
        <meta
