...
const BlogPage = ({ blog }) => {
  ...
  const canonicalUrl = `https://rapidautoshipping.com/${slug || "alabama"}`;
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <Link
                  href={`https://www.facebook.com/sharer/sharer.php?u=https://rapidautoshipping.com/${slug}/`}
                  target="_blank"
                ...
                <Link
                  href={`https://twitter.com/intent/tweet?url=https://rapidautoshipping.com/${slug}/&text=${encodeURIComponent(pageH1 || title)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <Link
                  href={`https://www.linkedin.com/shareArticle?url=https://rapidautoshipping.com/${slug}/`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <button
                  onClick={() => {
                    if (navigator.share) {
                      navigator.share({
                        title: pageH1 || title,
                        url: `https://rapidautoshipping.com/${slug}/`,
                      });
                    } else {
                      navigator.clipboard.writeText(
                        `https://rapidautoshipping.com/${slug}/`,
                      );
...
export async function getServerSideProps({ params }) {
  ...
  try {
    const res = await fetch(`https://api.rapidautoshipping.com/api/${slug}`);
    if (!res.ok) {
