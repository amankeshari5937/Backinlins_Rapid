...
const TestimonialSwiperAcross = () => {
  const testimonials = [
    {
      id: 1,
      name: "Maeg Diokno",
      image:
        "https://res.cloudinary.com/dz2zovmf1/image/upload/v1748698478/Maeg-Diokno_kzzejs.jpg",
      secondaryImage:
        "https://res.cloudinary.com/dz2zovmf1/image/upload/w_96,h_96,c_fit,q_auto,f_webp/v1742461263/review-card/goggle-review.webp",
      content:
        "Joe Keeps was very friendly, helpful and accommodating for our cross country move from California to South Carolina, especially during a busy holiday weekend. He made sure a driver was assigned for our desired pickup and dropoff dates, and checked in along the way to ensure I was getting the service I needed. 100% recommend Rapid Auto Shipping for all your car transport needs 😁",
      rating: 5,
      date: "2025-02-28",
    },
    {
      id: 2,
      name: "Kemper Brinkley",
      image:
        "https://res.cloudinary.com/dz2zovmf1/image/upload/v1748698635/Kemper-Brinkley_cfh76l.jpg",
      secondaryImage:
        "https://res.cloudinary.com/dz2zovmf1/image/upload/w_96,h_96,c_fit,q_auto,f_webp/v1742461263/review-card/Trustpilot.webp",
      content:
        "Best Car hauling Company to move vehicle from one state to the other state seamlessly.I was very much confused while looking for my car transportation  as i was doing it for the first time then i spoke with one of the person from this company and they were confident to deliver my vehicle so i have booked them and within couple of days my vehicle was picked up successfully and then delivered in just 3 days which was quiet amazing for me. Will book them again for any future car shipments.",
      rating: 5,
      date: "2024-05-28",
    },
    {
  ...
  return (
    <div class женщи className="w-full container mx-auto sm:px-4 py-10 my-10">
      ...
      <div className="relative px-8 lg:px-12">
       ...
       <button
  onClick={prevSlide}
  className="absolute top-1/2 left-0 -translate-y-1/2 bg-white rounded-full min-w-[48px] min-h-[48px] flex items-center justify-center shadow-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
...
>
  <ChevronLeft className="w-6 h-6" />
        ...
        <button
  onClick={nextSlide}
  className="absolute top-1/2 right-0 -translate-y-1/2 bg-white rounded-full min-w-[48px] min-h-[48px] flex items-center justify-center shadow-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
  aria-label="Previous testimonial"
>
...
export default TestimonialSwiperAcross;