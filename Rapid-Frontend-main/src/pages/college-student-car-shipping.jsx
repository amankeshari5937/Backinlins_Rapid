...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>College Student Car Shipping | Safe Door-to-Dorm Delivery</title>
        <meta
          name="description"
          content="Rapid Auto Shipping makes moving to campus easy with safe car shipping for students. We manage your insured, discounted delivery so you can focus on move-in."
        />
        <meta charSet="UTF-8" />
        ...
        <meta
          property="og:title"
          content="College Student Car Shipping | Safe Door-to-Dorm Delivery"
        />
        <meta
