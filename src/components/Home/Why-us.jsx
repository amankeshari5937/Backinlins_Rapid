    ...
    <div className="flex flex-col py-10 my-10 gap-8 lg:flex-row items-center justify-between container mx-auto lg:p-[1.25rem] bg-white min-h-[600px] w-full ">
        ...
        {[
          {
            ...
            text: "We provide hassle-free and reliable service to all 50 states of the USA, covering remote destinations as well as bustling cities alike.",
          },
          {
            title: "Affordable Pricing",
            text: "Our transparent and competitive pricing system provides cost-effective transportation solutions without compromising on shipping quality.",
          },
          {
            title: "Instant Online Quotes",
            text: "We offer clear and upfront vehicle shipping quotes tailored to your specific needs. Get a free, no-obligation car shipping quote in seconds.",
          },
          {
          ...
          },
          {
            ...
            text: "Every shipment is backed by comprehensive insurance, ensuring your peace of mind. From the pickup to the delivery, your vehicle is always in safe hands.",
          },
          {
      ...
      <div className="w-full lg:w-2/5 flex  justify-center mt-0 md:mt-20 bg-gray-500 h-[500px] md:h-[600px] rounded-lg overflow-hidden">
        <img
          ...
          className="w-full h-full object-cover" alt="Why Choose Rapid Auto Shipping – trusted nationwide car transport services in the USA"
        />
      </div>
    </div>
  );
