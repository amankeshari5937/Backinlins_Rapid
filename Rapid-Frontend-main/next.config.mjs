...
const nextConfig = {
  images: {
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "rapidautoshipping.com",
  ...
  redirects: async () => {
    return [
      ...
      {
        source: "/california-to-georgia-auto-transport-service",
        destination:
          "https://rapidautoshipping.com/state-to-state/california-to-georgia",
        permanent: true,
      },
      {
        source: "/alabama-to-kentucky-auto-shipping",
        destination:
          "https://rapidautoshipping.com/state-to-state/alabama-to-kentucky",
        permanent: true,
      },
      {
        source: "/arizona-to-west-virginia-auto-transport-service",
        destination:
          "https://rapidautoshipping.com/state-to-state/arizona-to-west-virginia",
        permanent: true,
      },
      {
        source: "/arizona-to-west-virginia-auto-transport-service",
      ...
      {
        source: "/blogs/ship-from-new-york-to-florida",
        destination:
          "https://rapidautoshipping.com/state-to-state/new-york-to-florida",
        permanent: true,
      },
      {
        source: "/blogs/cost-from-texas-to-california",
        destination:
          "https://rapidautoshipping.com/state-to-state/california-to-texas",
        permanent: true,
      },
