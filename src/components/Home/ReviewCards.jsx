...
const reviews = [
  {
    logo: "https://res.cloudinary.com/dz2zovmf1/image/upload/v1749742089/66ede09890c1d16a8ccb2d2c_1_snxhz7.png",
    title: "Clutch",
...
const ReviewCards = () => {
  return (
    <div className="flex flex-col mt-20 md:mt-0 items-center lg:flex-row justify-center gap-8 px-4 pb-8 mb-6">
      {reviews.map((review, index) => (
        ...
        >
          ...
          />
          <span className="font-semibold text-xl mb-2 block">{review.title}</span>
