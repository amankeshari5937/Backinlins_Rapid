...
const blogs = [
  ...
  },
  {
    ...
    alt: "Vehicle on a transport trailer traveling from New York to Florida",
    link: "https://rapidautoshipping.com/blogs/ship-from-new-york-to-florida",
  },
  {
...
const BlogCard = ({ title, description, image, link, alt }) => {
  return (
    ...
    >
      <img src={image} alt={alt} className="w-full h-[200px] object-cover" loading="lazy" />
