...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>Tractor Transport Services | No-Hassle Flatbed Hauling</title>
        <meta
          name="description"
          content="Rapid Auto Shipping manages professional tractor transport for farms and sites. We ship your heavy machinery on specialized and insured trailers."
        />
        <meta charSet="UTF-8" />
        ...
        <meta
          property="og:title"
          content="Tractor Transport Services | No-Hassle Flatbed Hauling"
        />
        <meta
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Rapid Auto Shipping manages professional tractor transport for farms and sites. We ship your heavy machinery on specialized and insured trailers.",
              hasFAQ: {
                "@type": "FAQPage",
                mainEntity: [
                  {
