...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>Cost to Ship a Bus | Instant Quotes & Safe Heavy Hauling </title>
        <meta
          name="description"
          content="Rapid Auto Shipping provides clear pricing for professional bus transport. We manage every detail of your insured, heavy-haul move with no hidden fees."
        />
        <meta charSet="UTF-8" />
        ...
        <meta
          property="og:title"
          content="Cost to Ship a Bus | Instant Quotes & Safe Heavy Hauling"
        />
        <meta
